...
#include "AutoMesh2RigInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UAutoMesh2RigInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UAutoMesh2RigInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UAutoMesh2RigInteractiveTool* NewTool = NewObject<UAutoMesh2RigInteractiveTool>(SceneState.ToolManager);
...
void UAutoMesh2RigInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UAutoMesh2RigInteractiveTool::Setup()
{
	...
	Properties = NewObject<UAutoMesh2RigInteractiveToolProperties>(this, "Measurement");
...
void UAutoMesh2RigInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UAutoMesh2RigInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UAutoMesh2RigInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UAutoMesh2RigInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UAutoMesh2RigInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UAutoMesh2RigInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UAutoMesh2RigInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UAutoMesh2RigInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UAutoMesh2RigInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
