...
#include "AutoMesh2RigInteractiveTool.generated.h"
 ...
 */
UCLASS()
class AUTOMESH2RIG_API UAutoMesh2RigInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class AUTOMESH2RIG_API UAutoMesh2RigInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UAutoMesh2RigInteractiveToolProperties();
 ...
 */
UCLASS()
class AUTOMESH2RIG_API UAutoMesh2RigInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAutoMesh2RigInteractiveToolProperties> Properties;
