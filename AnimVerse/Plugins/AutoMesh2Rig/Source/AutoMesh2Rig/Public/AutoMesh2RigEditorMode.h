...
#include "AutoMesh2RigEditorMode.generated.h"
 ...
 */
UCLASS()
class UAutoMesh2RigEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_AutoMesh2RigEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UAutoMesh2RigEditorMode();
	virtual ~UAutoMesh2RigEditorMode();
